...
API_ID = 29470264
API_HASH = "8d8ac63951444936f00d7bb9111976f8"
BOT_TOKEN = "6701423600:AAFcrpwonBJHvvBX-oWi3UHA0wk-jsqulaY"
AUTH_USERS = 5933953975
sudo_users = [5933953975]
bot = Client(
    "bot",
    bot_token=BOT_TOKEN,
    api_id=API_ID,
...
async def account_login(bot: Client, m: Message):
 editable = await m.reply_text("**hello I'm Alive Send /down download and for classplus send /clps  for /dhurina for /vision**")
